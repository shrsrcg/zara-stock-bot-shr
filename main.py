...
# Helpers (Zara/Bershka/H&M/Mango/Stradivarius)
try:
    from scraperHelpers import check_stock_zara, check_stock_bershka, check_stock_hm, check_stock_mango, check_stock_stradivarius
